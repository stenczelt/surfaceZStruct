...
void Termination100::findHollow(const int offsetX, const int offsetY)
{
...
void Termination100::findAtop(const int offsetX, const int offsetY)
{
...
void Termination100::findBridge(const int offsetX, const int offsetY)
{
    double offX = offsetX * mDeltaX + (mDeltaX/2);
    double offY = offsetY * mDeltaX;
