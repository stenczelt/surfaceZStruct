...
int SVD(double* A, double* U, double* eigen, int m, int n){
...
// "A" refers to full SVD, returning all vectors
  ...
  dgesvd_((char*)"A", (char*)"S", &m, &n, A, &LDA, S, U, &m, Vt, &n, Work, &LenWork, &Info);
